...
class Pedido(db.Model):
    ...
    data_hora = db.Column(db.DateTime, default=datetime.utcnow)  # Data do pedido
    data_retirada = db.Column(db.DateTime, nullable=True)  # Data em que o pedido foi retirado
